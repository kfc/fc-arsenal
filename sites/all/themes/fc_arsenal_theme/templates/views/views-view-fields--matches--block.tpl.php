		...
		<div class="match-block">
			<div class="players">
				<div class="team-block">
					...
					<div class="team-names-line">
						<?php echo $variables['match']['teams']['first']['name'];?>
					</div>
				</div>
				<div class="vs">VS</div>
				<div class="team-block">
					...
					<div class="team-names-line">
						<?php echo mb_wordwrap($variables['match']['teams']['second']['name'], 10, '<br />', 1);?>
					</div>
				</div>
				<div class="cf">&nbsp;</div>
			</div>
			<div class="score">
				<?php echo $variables['match']['score'];?>
			</div>
			<div class="tournament-type">
				<?php echo render($fields['field_match_tournament'] -> content);?>
			</div>
			<div class="date">
				<?php echo $variables['match']['start_date'];?>
			</div>
		</div>
	</div>
