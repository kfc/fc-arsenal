  ...
  <table class="tournament-table">
    <thead>
      <tr>
        ...
        <th><?php echo t('Team');?></th><th><?php echo t('Games played');?></th><th><?php echo t('Won');?></th><th><?php echo t('Drawn');?></th><th><?php echo t('Lost');?></th><th><?php echo t('Goals for');?></th><th><?php echo t('Goals against');?></th><th><?php echo t('Goal difference');?></th><th><?php echo t('Points');?></th></tr></thead>
<tbody>
<?php $i=0; 
